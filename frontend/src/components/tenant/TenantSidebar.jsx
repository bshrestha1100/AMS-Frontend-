...
const TenantSidebar = () => {
    console.log("TenantSidebar rendering");

    const [sidebar, setSidebar] = useState(false);
    const [userData, setUserData] = useState({ name: 'Loading...', role: 'tenant' });
    ...
    return (
        <>
            <div className="navbar">
                ...
                <h2 style={{ color: 'white', marginLeft: '16px', fontSize: '1.5rem' }}>Tenant Panel</h2>
            ...
            <nav className={sidebar ? 'nav-menu active' : 'nav-menu'}>
                <ul className="nav-menu-items" onClick={showSidebar}>
                        ...
                        <div style={{
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: '0.75rem', color: '#a0a0a0' }}>
                                    {userData.role?.charAt(0).toUpperCase() + userData.role?.slice(1) || 'Tenant'}
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li className="nav-text">
                        <NavLink to="/tenant/room-details">
                            <FaBuilding />
                            <span>My Room</span>
                        </NavLink>
                    </li>
                    ...
                    <li className="nav-text">
                        <NavLink to="/tenant/rooftop">
                            <FaUmbrellaBeach />
                            <span>Rooftop Services</span>
                        </NavLink>
                    </li>
